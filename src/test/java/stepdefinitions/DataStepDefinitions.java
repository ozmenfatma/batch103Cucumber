...
public class DataStepDefinitions {
    ...
    public void kullanici_new_butonuna_tiklar() {
        ...
        Driver.waitAndClick(dataTablesPage.newButon, 10);////new butonuna 10 saniye bekle sonra tikla ilk sefer de tiklarsan bekleme
    }
    ...
    public void kullanici_first_name_girer(String string) {
        ...
        Driver.waitAndSendText(dataTablesPage.firstName, string, 10);//10 yazmassam 5 sn bekler driver daki koddan dolayi
    }
